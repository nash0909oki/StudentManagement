...
## DB構造
  students（親テーブル）　                       students_courses（子テーブル）
+------------------------                      +-------------------------------+
| id (PK,AUTO_INCREMENT)   |◄──────────────┐   | id (PK)                       |
| full_name(NOT NULL)      |               └─▶ | student_id (FK)               |
| kana_name(NOT NULL)      |                   | course_name(NOT NULL)         |
| nickname                 |                   | start_date                    |
| email_address (NOT NULL) |                   | end_date                        |
| address                  |                   +-------------------------------+
| age                      |
| sex                      |
| remark                   |
